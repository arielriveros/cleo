...
export default function MenuBar() {
  ...
  const libraries = () => ({ materials, terrainMaterials, templates, models, scripts: scriptAssets, animationFields, animations, tilesets, aiBrains, audioSources, soundSamples });
    ...
    try {
      ...
      try {
        ...
        data = await buildMultiSceneGameData({
          ...
          libs: { materials, models, templates, terrainMaterials, scripts: scriptAssets, tilesets, aiBrains, animations },
          scriptAssets,
