...
@group(0) @binding(0) var u_shadowCascades_texture: texture_2d_array<f32>;
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    let d = textureSample(u_shadowCascades_texture, u_shadowCascades_sampler, in.uv, u_debug.u_layer).r;
